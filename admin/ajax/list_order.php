...
<!--                        <tr>
                            <td><strong>Скидка, %</strong></td>
                                <td></td>
                                <td align="center"><input type="text" id="discount<?php // echo $orderInfo['id']?>" value="<?php // echo $orderInfo['discount']?>" onkeyup="updateItemVal('orders','discount','discount<?php // echo $orderInfo['id']?>','<?php // echo $orderInfo['id']?>');" style="width:30px;"/></td>
				<td ></td>
                                <td></td>
                                <td ></td>
                                <td ></td>
				<td align="center"><a onclick="listOrder(<?php // echo $orderId?>)" class="btn btn-success" data-toggle="tooltip" title="" role="button" data-original-title="Удалить">
                                    <i class="glyphicon glyphicon-refresh"></i>
                                </a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            <td><strong>Итого, тенге</strong></td>
                                <td></td>
                                <td></td>
				<td ></td>
                                <td></td>
                                <td align="center"><strong><?=$orderInfo['total']?></strong></td>
                                <!--<td align="center"><strong><?php // echo ($total_install>0?$install_base+$total_install:0)?></strong></td>-->
				<td></td>
			</tr>
                        <tr>
                            <td><strong>Добавить товар</strong></td>
                            <td colspan="5"><input type="text" id="addArt" placeholder="артикул" style="width:150px;"></td>
                            <td align="center">
