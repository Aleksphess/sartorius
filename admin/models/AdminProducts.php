...
class admin_catalog_products extends AdminTable
{
    ...
    function __construct()
    {
        ...
        $this->fld[] = new Field("documentation_1","Первый документ",11);
        $this->fld[] = new Field("documentation_2","Второй документ",11);
        $this->fld[] = new Field("documentation_3","Третий документ",11);
        $this->fld[] = new Field("documentation_4","Четвертый документ",11);
        $this->fld[] = new Field("documentation_5","Пятый документ",11);
        $this->fld[] = new Field("documentation_6","Шестой документ",11);
...
//        $this->fld[] = new Field("context_brand","Контекст с брендом",6);
        ...
        $this->fld[] = new Field("txt","Описание первой вкладки",2,array('multiLang'=>1));
        $this->fld[] = new Field("txt_1","Описание второй вкладки",2,array('multiLang'=>1));

        $this->fld[] = new Field("txt_2","Описание третей вкладки",2,array('multiLang'=>1));
        $this->fld[] = new Field("txt_3","Описание четвертой вкладки",2,array('multiLang'=>1));
