...
class admin_pages extends AdminTable
{
    ...
    function __construct()
    {
        $this->fld=array(
            ...
            new Field("use_callback", "Выводить форму обратного звонка (для статических страниц)", 6),
            new Field("use_gallery", "Выводить галерею (для статических страниц)", 6),
            new Field("show_advantages", "Отображать преимущества (для статических страниц)", 6),
